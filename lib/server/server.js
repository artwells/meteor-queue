...
Queue.setInterval = function(name, func, interval){
    handle = Meteor.setInterval(function(){eval(func)}, interval);
    task = {
        name: name,
        func: func,
        handle: handle,
    ...
    Meteor.methods({
        addQueueRunNow : function(){   
            if (typeof Houston !== "undefined"  
                && typeof '_houston_queue/Run Now' === "undefined") {
